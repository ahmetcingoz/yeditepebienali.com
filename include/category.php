												...
												<li class="item <?php echo _seo($article_key) ?> wow fadeInUp" data-wow-delay="0.1s">
													<div class="holder">
														...
														<div class="caption">
															<div class="c1">
																<div class="c2">
																	<a href="<?php echo _seo(_translate('exhibition', $article_key) . '-' . $subcategory_date_key)?>"><strong class="title"><?php echo _uppercase(_translate('exhibition', $article_key))?></strong></a>
